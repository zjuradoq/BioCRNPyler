    ...
    def update_reactions(
        ...
        **kwargs
        ...
        for key, ionI, ionO in zip(
            ...
            # ion_out + MC <--> ion:MC
            rxn_ionMC = Reaction.from_massaction(
                [ion_num*[ionO], membrane_carrier],
                [complex_dict[f'{key}_out:MC']],
                k_forward=kb_ionMC_out,
                k_reverse=ku_ionMC_out,
            )
            secondaryactive_rxns.append(rxn_ionMC)
    ...
    def update_reactions(
        ...
        **kwargs
        ...
        for key, ionI, ionO in zip(
            ...
            rxn_ionMC_out = Reaction.from_massaction(
                [ion_num*[ionO], membrane_carrier],
                [complex_dict[f'{key}_out:MC']],
                k_forward=kb_ionMC_out,
                k_reverse=ku_ionMC_out,
            )
            secondaryactive_rxns.append(rxn_ionMC_out)
            ...
            rxn_ionMC_in = Reaction.from_massaction(
                [complex_dict[f'{key}_in:MC']],
                [ion_num*[ionI], carrier_in],
                k_forward=kb_ionMC_in,
                k_reverse=ku_ionMC_in,
            )
            secondaryactive_rxns.append(rxn_ionMC_in)
