...
from ..mechanisms.signaling import Sensor_TwoComponentSystem
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            ...
            name=name,
            attributes=attributes,
            default_mechanism=Diffusion_Simple(),
            **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            self=self,
            name=name,
            default_mechanism=Integration_MembraneProtein(),
            **kwargs)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            self=self,
            name=name,
            default_mechanism=Diffusion_Facilitated_Channel(),
            **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            self=self,
            name=name,
            default_mechanism=Diffusion_Facilitated_Carrier(),
            **kwargs
        )
...
#New>>>
    def _get_active_mechanism(self):
        """Helper method to fetch either diffusion or transport mechanism."""
        mech = self.get_mechanism('transport', optional_mechanism=True)
        if mech is None:
            mech = self.get_mechanism('diffusion', optional_mechanism=True)
        if mech is None:
            raise KeyError(f"Unable to find mechanism of type 'diffusion' or"
                           f" 'transport' in {self}.")
        return mech
#<<<< new
    def update_species(self):
        ...
        # if mech_tra is None:
        #     raise KeyError(
        #         f"Unable to find mechanism of type diffusion or
        # transport
        # in
        #         f"Component {self}."
        #     )
        mech_tra = self._get_active_mechanism()
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            self=self,
            name=name,
            default_mechanism=Transport_PrimaryActive_ABCexporter(),
            **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Component.__init__(
            self=self,
            name=name,
            default_mechanism=Sensor_TwoComponentSystem(),
            **kwargs
        )
